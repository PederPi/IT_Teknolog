...
void update_motors(){
  int x_axis = 0;
  x_axis = map(analogRead(A1), 0, 1023, -100, 100);
...
//DHT22 humidity sensor handling functions:
...
void update_steering(){
  //Need code from wireless!!!!
  int y_axis = 0;
  y_axis = map(analogRead(A0), 0, 1023, 135, 45);
